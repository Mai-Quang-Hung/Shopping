...
const Checkout = () => {
    ...
    const itemList = (item) => {
        totals =  total += item.qty * item.price

        return (
            
             <li className="list-group-item d-flex justify-content-between lh-sm table-bordered" key={item.id}>
                 <div>
                    <h6 className="my-0 list_title">{item.title}</h6>
